...
<div class="card">
   <div class="card-header">
      <h3 class="card-title card_title_center">     فواتير مرتجع  المشتريات باصل الفاتورة</h3>
      <input type="hidden" id="token_search" value="{{csrf_token() }}">
      <input type="hidden" id="ajax_search_url" value="{{ route('admin.suppliers_orders.ajax_search') }}">
      <a href="{{ route('admin.Suppliers_orders_return_original_invoice.create') }}" class="btn btn-sm btn-success" >اضافة جديد</a>
   </div>
   <!-- /.card-header -->
   <div class="card-body">
      <div class="row">
