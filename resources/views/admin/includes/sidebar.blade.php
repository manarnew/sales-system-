<aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <img src="{{ asset('assets/admin/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
      style="opacity: .8">
   <span class="brand-text font-weight-light">Manar Soft Pos</span>
   </a>
   <!-- Sidebar -->
   <div class="sidebar">
      ...
      <nav class="mt-2">
         ...
         @endif
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/suppliers_orders*') ||request()->is('admin/suppliers_orders_general_return*') ||request()->is('admin/itemcardBalance*') ||request()->is('admin/stores_inventory*') ||request()->is('admin/inv_stores_transfer*') ||request()->is('admin/inv_stores_transfer_incoming*') ||request()->is('admin/Suppliers_orders_return_original_invoice*') )?'menu-open':'' }}     ">
               <a href="#" class="nav-link {{ (request()->is('admin/suppliers_orders*') ||request()->is('admin/suppliers_orders_general_return*') ||request()->is('admin/itemcardBalance*')  ||request()->is('admin/stores_inventory*') ||request()->is('admin/inv_stores_transfer*') ||request()->is('admin/inv_stores_transfer_incoming*') ||request()->is('admin/Suppliers_orders_return_original_invoice*'))?'active':'' }}">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                     حركات مخزنية
                     <i class="right fas fa-angle-left"></i>
               ...
               <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                     <a href="{{ route('admin.Suppliers_orders_return_original_invoice.index') }}" class="nav-link {{ (request()->is('admin/Suppliers_orders_return_original_invoice*')  )?'active':'' }}">
                        <p>
