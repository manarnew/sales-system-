    ...
    protected $fillable=[
        'order_type', 'auto_serial', 'DOC_NO', 'order_date', 'suuplier_code', 'is_approved', 'com_code',
         'notes', 'discount_type', 'discount_percent', 'discount_value', 'tax_percent', 'tax_value',
          'total_befor_discount', 'total_cost', 'account_number', 'money_for_account', 'pill_type','original_invoice_id_for_return',
           'what_paid', 'what_remain', 'treasuries_transactions_id', 'Supplier_balance_befor','suppliers_with_orders',
