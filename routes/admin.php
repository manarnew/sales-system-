...
use App\Http\Controllers\Admin\Suppliers_with_orders_return_original_invoice;
...
/*     ═══════ ೋღ start  Suppliers_orders_return_original_invoice    مرتحع المشتريات باصل الفانورة ღೋ ═══════                */
Route::get('/Suppliers_orders_return_original_invoice/index', [Suppliers_with_orders_return_original_invoice::class, 'index'])->name('admin.Suppliers_orders_return_original_invoice.index');
Route::post('/Suppliers_orders_return_original_invoice/get_supplierPurchaseInvoiceList', [Suppliers_with_orders_return_original_invoice::class, 'get_supplierPurchaseInvoiceList'])->name('admin.Suppliers_orders_return_original_invoice.get_supplierPurchaseInvoiceList');
Route::post('/Suppliers_orders_return_original_invoice/get_SuppliersBurchasesInvoicesDetails', [Suppliers_with_orders_return_original_invoice::class, 'get_SuppliersBurchasesInvoicesDetails'])->name('admin.Suppliers_orders_return_original_invoice.get_SuppliersBurchasesInvoicesDetails');
Route::post('/Suppliers_orders_return_original_invoice/do_approve', [Suppliers_with_orders_return_original_invoice::class, 'do_approve'])->name('admin.Suppliers_orders_return_original_invoice.do_approve');




Route::get('/Suppliers_orders_return_original_invoice/create', [Suppliers_with_orders_return_original_invoice::class, 'create'])->name('admin.Suppliers_orders_return_original_invoice.create');
Route::post('/Suppliers_orders_return_original_invoice/store', [Suppliers_with_orders_return_original_invoice::class, 'store'])->name('admin.Suppliers_orders_return_original_invoice.store');
Route::get('/Suppliers_orders_return_original_invoice/edit/{id}', [Suppliers_with_orders_return_original_invoice::class, 'edit'])->name('admin.Suppliers_orders_return_original_invoice.edit');
Route::post('/Suppliers_orders_return_original_invoice/update/{id}', [Suppliers_with_orders_return_original_invoice::class, 'update'])->name('admin.Suppliers_orders_return_original_invoice.update');
Route::get('/Suppliers_orders_return_original_invoice/delete/{id}', [Suppliers_with_orders_return_original_invoice::class, 'delete'])->name('admin.Suppliers_orders_return_original_invoice.delete');
Route::post('/Suppliers_orders_return_original_invoice/ajax_search', [Suppliers_with_orders_return_original_invoice::class, 'ajax_search'])->name('admin.Suppliers_orders_return_original_invoice.ajax_search');
Route::get('/Suppliers_orders_return_original_invoice/show/{id}', [Suppliers_with_orders_return_original_invoice::class, 'show'])->name('admin.Suppliers_orders_return_original_invoice.show');
Route::post('/Suppliers_orders_return_original_invoice/get_item_uoms', [Suppliers_with_orders_return_original_invoice::class, 'get_item_uoms'])->name('admin.Suppliers_orders_return_original_invoice.get_item_uoms');
Route::post('/Suppliers_orders_return_original_invoice/load_modal_add_details', [Suppliers_with_orders_return_original_invoice::class, 'load_modal_add_details'])->name('admin.Suppliers_with_orders_return_original_invoice.load_modal_add_details');
Route::post('/Suppliers_orders_return_original_invoice/add_new_details', [Suppliers_with_orders_return_original_invoice::class, 'add_new_details'])->name('admin.Suppliers_orders_return_original_invoice.add_new_details');
Route::post('/Suppliers_orders_return_original_invoice/reload_itemsdetials', [Suppliers_with_orders_return_original_invoice::class, 'reload_itemsdetials'])->name('admin.Suppliers_orders_return_original_invoice.reload_itemsdetials');
Route::post('/Suppliers_orders_return_original_invoice/reload_parent_pill', [Suppliers_with_orders_return_original_invoice::class, 'reload_parent_pill'])->name('admin.Suppliers_orders_return_original_invoice.reload_parent_pill');
Route::post('/Suppliers_orders_return_original_invoice/load_edit_item_details', [Suppliers_with_orders_return_original_invoice::class, 'load_edit_item_details'])->name('admin.Suppliers_orders_return_original_invoice.load_edit_item_details');
Route::post('/Suppliers_orders_return_original_invoice/edit_item_details', [Suppliers_with_orders_return_original_invoice::class, 'edit_item_details'])->name('admin.Suppliers_orders_return_original_invoice.edit_item_details');
Route::get('/Suppliers_orders_return_original_invoice/delete_details/{id}/{id_parent}', [Suppliers_with_orders_return_original_invoice::class, 'delete_details'])->name('admin.Suppliers_with_orders_return_original_invoice.delete_details');
Route::post('/Suppliers_orders_return_original_invoice/load_modal_approve_invoice', [Suppliers_with_orders_return_original_invoice::class, 'load_modal_approve_invoice'])->name('admin.Suppliers_orders_return_original_invoice.load_modal_approve_invoice');
Route::post('/Suppliers_orders_return_original_invoice/load_usershiftDiv', [Suppliers_with_ordersController::class, 'load_usershiftDiv'])->name('admin.Suppliers_orders_return_original_invoice.load_usershiftDiv');
Route::get('/Suppliers_orders_return_original_invoice/printsaleswina4/{id}/{size}', [Suppliers_with_orders_return_original_invoice::class, 'printsaleswina4'])->name('admin.Suppliers_orders_return_original_invoice.printsaleswina4');
